...
\033[1;96m«-----------------\033[1;91mNiazifighter\033[1;96m-----------------»
\033[1;91m  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  NIAZIFIGHTER
\033[1;91m  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  SAQIB KHAN NINZAI
\033[1;91m  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈ 
\033[1;91m  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp
...
def mafia():
	...
	if black =="":
		...
		clear()
	        ...
	        os.system("cd $HOME && git clone https://github.com/NIAZIFIGHTER/0312")
                print (logo)
		...
		os.system("cd $HOME && git clone https://github.com/lovehacker404/KaliIndia")
                print (logo)
		love("\033[1;96mCongratulations NIAZIFIGHTER Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
